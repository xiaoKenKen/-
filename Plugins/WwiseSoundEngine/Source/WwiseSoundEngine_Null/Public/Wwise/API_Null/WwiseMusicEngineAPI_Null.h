...
class WWISESOUNDENGINE_API FWwiseMusicEngineAPI_Null : public IWwiseMusicEngineAPI
{
public:
	UE_NONCOPYABLE(FWwiseMusicEngineAPI_Null);
	FWwiseMusicEngineAPI_Null() = default;
