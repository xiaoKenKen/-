...
AKRESULT FWwiseSoundEngineAPI_2022_1::Init(
...
void FWwiseSoundEngineAPI_2022_1::GetDefaultInitSettings(
...
void FWwiseSoundEngineAPI_2022_1::GetDefaultPlatformInitSettings(
...
void FWwiseSoundEngineAPI_2022_1::Term()
{
...
AKRESULT FWwiseSoundEngineAPI_2022_1::GetAudioSettings(
...
AkChannelConfig FWwiseSoundEngineAPI_2022_1::GetSpeakerConfiguration(
...
AKRESULT FWwiseSoundEngineAPI_2022_1::GetOutputDeviceConfiguration(
	AkOutputDeviceID in_idOutput,
...
AKRESULT FWwiseSoundEngineAPI_2022_1::SetPanningRule(
...
AKRESULT FWwiseSoundEngineAPI_2022_1::GetSpeakerAngles(
...
AKRESULT FWwiseSoundEngineAPI_2022_1::SetSpeakerAngles(
...
AKRESULT FWwiseSoundEngineAPI_2022_1::SetVolumeThreshold(
...
AKRESULT FWwiseSoundEngineAPI_2022_1::SetMaxNumVoicesLimit(
...
AK::IAkGlobalPluginContext* FWwiseSoundEngineAPI_2022_1::GetGlobalPluginContext()
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
	return AK::SoundEngine::GetGlobalPluginContext();
}

AKRESULT FWwiseSoundEngineAPI_2022_1::RegisterPlugin(
...
AKRESULT FWwiseSoundEngineAPI_2022_1::RegisterPluginDLL(
...
AKRESULT FWwiseSoundEngineAPI_2022_1::RegisterGlobalCallback(
...
AKRESULT FWwiseSoundEngineAPI_2022_1::UnregisterGlobalCallback(
	AkGlobalCallbackFunc in_pCallback,
	AkUInt32 in_eLocation
)
{
...
AKRESULT FWwiseSoundEngineAPI_2022_1::RegisterResourceMonitorCallback(
...
AKRESULT FWwiseSoundEngineAPI_2022_1::UnregisterResourceMonitorCallback(
	AkResourceMonitorCallbackFunc in_pCallback
)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
AKRESULT FWwiseSoundEngineAPI_2022_1::RegisterAudioDeviceStatusCallback(
...
AKRESULT FWwiseSoundEngineAPI_2022_1::UnregisterAudioDeviceStatusCallback()
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
AkUInt32 FWwiseSoundEngineAPI_2022_1::GetIDFromString(const wchar_t* in_pszString)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
AkUInt32 FWwiseSoundEngineAPI_2022_1::GetIDFromString(const char* in_pszString)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
	return AK::SoundEngine::GetIDFromString(in_pszString);
}

AkPlayingID FWwiseSoundEngineAPI_2022_1::PostEvent(
...
AKRESULT FWwiseSoundEngineAPI_2022_1::ExecuteActionOnEvent(
	AkUniqueID in_eventID,
...
AkPlayingID FWwiseSoundEngineAPI_2022_1::PostMIDIOnEvent(
	AkUniqueID in_eventID,
	AkGameObjectID in_gameObjectID,
...
AKRESULT FWwiseSoundEngineAPI_2022_1::StopMIDIOnEvent(
	AkUniqueID in_eventID,
	AkGameObjectID in_gameObjectID,
	AkPlayingID in_playingID
)
...
AKRESULT FWwiseSoundEngineAPI_2022_1::PinEventInStreamCache(
	AkUniqueID in_eventID,
...
AKRESULT FWwiseSoundEngineAPI_2022_1::UnpinEventInStreamCache(
	AkUniqueID in_eventID
)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
AKRESULT FWwiseSoundEngineAPI_2022_1::GetBufferStatusForPinnedEvent(
	AkUniqueID in_eventID,
...
void FWwiseSoundEngineAPI_2022_1::CancelEventCallbackCookie(
	void* in_pCookie
)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
void FWwiseSoundEngineAPI_2022_1::CancelEventCallbackGameObject(
	AkGameObjectID in_gameObjectID
)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
void FWwiseSoundEngineAPI_2022_1::CancelEventCallback(
	AkPlayingID in_playingID
)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
AKRESULT FWwiseSoundEngineAPI_2022_1::GetSourcePlayPosition(
	AkPlayingID		in_PlayingID,
...
AKRESULT FWwiseSoundEngineAPI_2022_1::GetSourcePlayPositions(
	AkPlayingID		in_PlayingID,
...
AKRESULT FWwiseSoundEngineAPI_2022_1::GetSourceStreamBuffering(
	AkPlayingID		in_PlayingID,
...
void FWwiseSoundEngineAPI_2022_1::StopAll(
	AkGameObjectID in_gameObjectID
)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
void FWwiseSoundEngineAPI_2022_1::StopPlayingID(
	AkPlayingID in_playingID,
	AkTimeMs in_uTransitionDuration,
	AkCurveInterpolation in_eFadeCurve
)
...
void FWwiseSoundEngineAPI_2022_1::ExecuteActionOnPlayingID(
	AK::SoundEngine::AkActionOnEventType in_ActionType,
	AkPlayingID in_playingID,
	AkTimeMs in_uTransitionDuration,
	AkCurveInterpolation in_eFadeCurve
...
void FWwiseSoundEngineAPI_2022_1::SetRandomSeed(
	AkUInt32 in_uSeed
)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
void FWwiseSoundEngineAPI_2022_1::MuteBackgroundMusic(
	bool in_bMute
)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
bool FWwiseSoundEngineAPI_2022_1::GetBackgroundMusicMute()
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
	return AK::SoundEngine::GetBackgroundMusicMute();
}

AKRESULT FWwiseSoundEngineAPI_2022_1::SendPluginCustomGameData(
	AkUniqueID in_busID,
...
AKRESULT FWwiseSoundEngineAPI_2022_1::RegisterGameObj(
	AkGameObjectID in_gameObjectID
)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
AKRESULT FWwiseSoundEngineAPI_2022_1::UnregisterGameObj(
	AkGameObjectID in_gameObjectID
)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
AKRESULT FWwiseSoundEngineAPI_2022_1::UnregisterAllGameObj(
)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
AKRESULT FWwiseSoundEngineAPI_2022_1::SetPosition(
	AkGameObjectID in_GameObjectID,
...
AKRESULT FWwiseSoundEngineAPI_2022_1::SetMultiplePositions(
	AkGameObjectID in_GameObjectID,
...
AKRESULT FWwiseSoundEngineAPI_2022_1::SetScalingFactor(
	AkGameObjectID in_GameObjectID,
...
AKRESULT FWwiseSoundEngineAPI_2022_1::SetDistanceProbe(
...
AKRESULT FWwiseSoundEngineAPI_2022_1::ClearBanks()
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
	return AK::SoundEngine::ClearBanks();
}

AKRESULT FWwiseSoundEngineAPI_2022_1::SetBankLoadIOSettings(
...
#ifdef AK_SUPPORT_WCHAR
AKRESULT FWwiseSoundEngineAPI_2022_1::LoadBank(
...
AKRESULT FWwiseSoundEngineAPI_2022_1::DecodeBank(
	const void* in_pInMemoryBankPtr,
	AkUInt32			in_uInMemoryBankSize,
...
#ifdef AK_SUPPORT_WCHAR
AKRESULT FWwiseSoundEngineAPI_2022_1::UnloadBank(
	const wchar_t* in_pszString,
	const void* in_pInMemoryBankPtr,
	AkBankType			in_bankType
)
...
void FWwiseSoundEngineAPI_2022_1::CancelBankCallbackCookie(
	void* in_pCookie
)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
#ifdef AK_SUPPORT_WCHAR
AKRESULT FWwiseSoundEngineAPI_2022_1::PrepareBank(
...
AKRESULT FWwiseSoundEngineAPI_2022_1::ClearPreparedEvents()
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
#ifdef AK_SUPPORT_WCHAR
AKRESULT FWwiseSoundEngineAPI_2022_1::PrepareEvent(
	AK::SoundEngine::PreparationType		in_PreparationType,
...
#ifdef AK_SUPPORT_WCHAR
AKRESULT FWwiseSoundEngineAPI_2022_1::PrepareBus(
...
AKRESULT FWwiseSoundEngineAPI_2022_1::SetMedia(
...
AKRESULT FWwiseSoundEngineAPI_2022_1::TryUnsetMedia(
	AkSourceSettings* in_pSourceSettings,
	AkUInt32          in_uNumSourceSettings,
...
#ifdef AK_SUPPORT_WCHAR
AKRESULT FWwiseSoundEngineAPI_2022_1::PrepareGameSyncs(
	AK::SoundEngine::PreparationType	in_PreparationType,
...
AKRESULT FWwiseSoundEngineAPI_2022_1::SetListeners(
...
AKRESULT FWwiseSoundEngineAPI_2022_1::AddListener(
	AkGameObjectID in_emitterGameObj,
...
AKRESULT FWwiseSoundEngineAPI_2022_1::RemoveListener(
	AkGameObjectID in_emitterGameObj,
	AkGameObjectID in_listenerGameObj
)
{
...
AKRESULT FWwiseSoundEngineAPI_2022_1::SetDefaultListeners(
...
AKRESULT FWwiseSoundEngineAPI_2022_1::AddDefaultListener(
	AkGameObjectID in_listenerGameObj
)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
AKRESULT FWwiseSoundEngineAPI_2022_1::RemoveDefaultListener(
	AkGameObjectID in_listenerGameObj
)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
AKRESULT FWwiseSoundEngineAPI_2022_1::ResetListenersToDefault(
	AkGameObjectID in_emitterGameObj
)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
AKRESULT FWwiseSoundEngineAPI_2022_1::SetListenerSpatialization(
...
AKRESULT FWwiseSoundEngineAPI_2022_1::SetRTPCValue(
	AkRtpcID in_rtpcID,
...
AKRESULT FWwiseSoundEngineAPI_2022_1::SetRTPCValueByPlayingID(
	AkRtpcID in_rtpcID,
	AkRtpcValue in_value,
	AkPlayingID in_playingID,
	AkTimeMs in_uValueChangeDuration,
...
AKRESULT FWwiseSoundEngineAPI_2022_1::SetSwitch(
...
AKRESULT FWwiseSoundEngineAPI_2022_1::PostTrigger(
...
AKRESULT FWwiseSoundEngineAPI_2022_1::SetState(
...
AKRESULT FWwiseSoundEngineAPI_2022_1::SetGameObjectAuxSendValues(
	AkGameObjectID		in_gameObjectID,
...
AKRESULT FWwiseSoundEngineAPI_2022_1::RegisterBusMeteringCallback(
	AkUniqueID in_busID,
...
AKRESULT FWwiseSoundEngineAPI_2022_1::RegisterOutputDeviceMeteringCallback(
	AkOutputDeviceID in_idOutput,
...
AKRESULT FWwiseSoundEngineAPI_2022_1::SetGameObjectOutputBusVolume(
...
AKRESULT FWwiseSoundEngineAPI_2022_1::SetActorMixerEffect(
...
AKRESULT FWwiseSoundEngineAPI_2022_1::SetOutputDeviceEffect(
...
AKRESULT FWwiseSoundEngineAPI_2022_1::SetBusConfig(
	AkUniqueID in_audioNodeID,
	AkChannelConfig in_channelConfig
)
{
...
AKRESULT FWwiseSoundEngineAPI_2022_1::SetObjectObstructionAndOcclusion(
...
AKRESULT FWwiseSoundEngineAPI_2022_1::SetContainerHistory(
...
AKRESULT FWwiseSoundEngineAPI_2022_1::StartOutputCapture(
...
AKRESULT FWwiseSoundEngineAPI_2022_1::StopOutputCapture()
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
AKRESULT FWwiseSoundEngineAPI_2022_1::RegisterCaptureCallback(
...
AKRESULT FWwiseSoundEngineAPI_2022_1::UnregisterCaptureCallback(
	AkCaptureCallbackFunc in_pfnCallback,
	AkOutputDeviceID in_idOutput,
	void* in_pCookie
)
...
AKRESULT FWwiseSoundEngineAPI_2022_1::StartProfilerCapture(
	const AkOSChar* in_CaptureFileName
)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
AKRESULT FWwiseSoundEngineAPI_2022_1::StopProfilerCapture()
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
	return AK::SoundEngine::StopProfilerCapture();
}

AKRESULT FWwiseSoundEngineAPI_2022_1::SetOfflineRenderingFrameTime(
...
AKRESULT FWwiseSoundEngineAPI_2022_1::SetOfflineRendering(
...
AKRESULT FWwiseSoundEngineAPI_2022_1::AddOutput(
...
AKRESULT FWwiseSoundEngineAPI_2022_1::RemoveOutput(
	AkOutputDeviceID in_idOutput
)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
AKRESULT FWwiseSoundEngineAPI_2022_1::ReplaceOutput(
	const AkOutputSettings& in_Settings,
	AkOutputDeviceID in_outputDeviceId,
...
AkOutputDeviceID FWwiseSoundEngineAPI_2022_1::GetOutputID(
...
AKRESULT FWwiseSoundEngineAPI_2022_1::SetBusDevice(
	AkUniqueID in_idBus,
...
AKRESULT FWwiseSoundEngineAPI_2022_1::GetDeviceList(
	AkUInt32 in_ulCompanyID,
	AkUInt32 in_ulPluginID,
...
AKRESULT FWwiseSoundEngineAPI_2022_1::SetOutputVolume(
	AkOutputDeviceID in_idOutput,
	AkReal32 in_fVolume
)
{
...
AKRESULT FWwiseSoundEngineAPI_2022_1::GetDeviceSpatialAudioSupport(
	AkUInt32 in_idDevice)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
AKRESULT FWwiseSoundEngineAPI_2022_1::Suspend(
...
AKRESULT FWwiseSoundEngineAPI_2022_1::WakeupFromSuspend(
...
AkUInt32 FWwiseSoundEngineAPI_2022_1::GetBufferTick()
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
	return AK::SoundEngine::GetBufferTick();
}

AkUInt64 FWwiseSoundEngineAPI_2022_1::GetSampleTick()
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
	return AK::SoundEngine::GetSampleTick();
}

AKRESULT FWwiseSoundEngineAPI_2022_1::FQuery::GetPosition(
	AkGameObjectID in_GameObjectID,
...
AKRESULT FWwiseSoundEngineAPI_2022_1::FQuery::GetListeners(
	AkGameObjectID in_GameObjectID,
...
AKRESULT FWwiseSoundEngineAPI_2022_1::FQuery::GetSwitch(
	AkSwitchGroupID in_switchGroup,
	AkGameObjectID  in_gameObjectID,
...
AKRESULT FWwiseSoundEngineAPI_2022_1::FQuery::GetState(
	AkStateGroupID in_stateGroup,
...
AKRESULT FWwiseSoundEngineAPI_2022_1::FQuery::GetGameObjectAuxSendValues(
	AkGameObjectID		in_gameObjectID,
...
AKRESULT FWwiseSoundEngineAPI_2022_1::FQuery::GetGameObjectDryLevelValue(
	AkGameObjectID		in_EmitterID,
	AkGameObjectID		in_ListenerID,
...
AKRESULT FWwiseSoundEngineAPI_2022_1::FQuery::GetObjectObstructionAndOcclusion(
	AkGameObjectID in_EmitterID,
	AkGameObjectID in_ListenerID,
...
AKRESULT FWwiseSoundEngineAPI_2022_1::FQuery::GetPositioningInfo(
...
AKRESULT FWwiseSoundEngineAPI_2022_1::FQuery::GetActiveGameObjects(
...
bool FWwiseSoundEngineAPI_2022_1::FQuery::GetIsGameObjectActive(
...
AKRESULT FWwiseSoundEngineAPI_2022_1::FQuery::GetMaxRadius(
...
AkReal32 FWwiseSoundEngineAPI_2022_1::FQuery::GetMaxRadius(
	AkGameObjectID in_GameObjId
)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
AkUniqueID FWwiseSoundEngineAPI_2022_1::FQuery::GetEventIDFromPlayingID(
	AkPlayingID in_playingID
)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
AkGameObjectID FWwiseSoundEngineAPI_2022_1::FQuery::GetGameObjectFromPlayingID(
	AkPlayingID in_playingID
)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
AKRESULT FWwiseSoundEngineAPI_2022_1::FQuery::GetPlayingIDsFromGameObject(
	AkGameObjectID in_GameObjId,
...
AKRESULT FWwiseSoundEngineAPI_2022_1::FQuery::GetCustomPropertyValue(
	AkUniqueID in_ObjectID,
	AkUInt32 in_uPropID,
	AkInt32& out_iValue
)
...
void FWwiseSoundEngineAPI_2022_1::FAudioInputPlugin::SetAudioInputCallbacks(
...
bool FWwiseSoundEngineAPI_2022_1::FErrorTranslator::GetInfo(TagInformation* in_pTagList, AkUInt32 in_uCount,
...
AkErrorMessageTranslator* FWwiseSoundEngineAPI_2022_1::NewErrorMessageTranslator(FGetInfoErrorMessageTranslatorFunction InMessageTranslatorFunction)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
#if WITH_EDITORONLY_DATA
