...
class WWISESOUNDENGINE_API FWwiseMemoryMgrAPI_2022_1 : public IWwiseMemoryMgrAPI
{
public:
	UE_NONCOPYABLE(FWwiseMemoryMgrAPI_2022_1);
	FWwiseMemoryMgrAPI_2022_1() = default;
