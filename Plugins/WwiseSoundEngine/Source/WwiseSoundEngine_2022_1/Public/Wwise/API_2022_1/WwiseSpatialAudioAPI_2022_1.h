...
class WWISESOUNDENGINE_API FWwiseSpatialAudioAPI_2022_1 : public IWwiseSpatialAudioAPI
{
public:
	UE_NONCOPYABLE(FWwiseSpatialAudioAPI_2022_1);
	FWwiseSpatialAudioAPI_2022_1();
