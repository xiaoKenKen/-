...
class FWwisePlatformAPI_2022_1_Windows : public IWwisePlatformAPI
{
public:
	UE_NONCOPYABLE(FWwisePlatformAPI_2022_1_Windows);
	FWwisePlatformAPI_2022_1_Windows() = default;
	virtual ~FWwisePlatformAPI_2022_1_Windows() override {}
...
using FWwisePlatformAPI = FWwisePlatformAPI_2022_1_Windows;
