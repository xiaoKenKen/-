...
class FWwisePlatformAPI_2022_1_TVOS : public IWwisePlatformAPI
{
public:
	UE_NONCOPYABLE(FWwisePlatformAPI_2022_1_TVOS);
	FWwisePlatformAPI_2022_1_TVOS() = default;
	virtual ~FWwisePlatformAPI_2022_1_TVOS() override {}
