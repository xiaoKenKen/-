...
class WWISESOUNDENGINE_API FWwiseMusicEngineAPI_2022_1 : public IWwiseMusicEngineAPI
{
public:
	UE_NONCOPYABLE(FWwiseMusicEngineAPI_2022_1);
	FWwiseMusicEngineAPI_2022_1() = default;
