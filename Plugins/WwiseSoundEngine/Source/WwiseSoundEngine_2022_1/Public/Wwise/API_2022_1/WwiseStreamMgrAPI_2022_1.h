...
class WWISESOUNDENGINE_API FWwiseStreamMgrAPI_2022_1 : public IWwiseStreamMgrAPI
{
public:
	UE_NONCOPYABLE(FWwiseStreamMgrAPI_2022_1);
	FWwiseStreamMgrAPI_2022_1() = default;
