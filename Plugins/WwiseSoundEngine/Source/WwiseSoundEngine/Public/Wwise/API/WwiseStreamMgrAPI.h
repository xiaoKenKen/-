...
public:
	...
	{
		if (auto* WwiseStreamMgr = Get())
		{
			return WwiseStreamMgr->GetAkStreamMgrInstance();
		}
		return nullptr;
	}

	UE_NONCOPYABLE(IWwiseStreamMgrAPI);
protected:
	IWwiseStreamMgrAPI() = default;
public:
	virtual ~IWwiseStreamMgrAPI() {}

	virtual AK::IAkStreamMgr* GetAkStreamMgrInstance() = 0;
	...
	/// - AK::StreamMgr::SetFileLocationResolver()
	virtual AK::StreamMgr::IAkFileLocationResolver* GetFileLocationResolver() = 0;
	...
	virtual const AkOSChar* GetCurrentLanguage() = 0;
