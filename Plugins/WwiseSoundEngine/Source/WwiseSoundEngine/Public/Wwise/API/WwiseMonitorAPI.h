...
{
public:
	static IWwiseMonitorAPI* Get()
	{
		IWwiseSoundEngineModule::ForceLoadModule();
		return IWwiseSoundEngineModule::Monitor;
	}
	
	UE_NONCOPYABLE(IWwiseMonitorAPI);
protected:
	IWwiseMonitorAPI() = default;
public:
	virtual ~IWwiseMonitorAPI() {}
	...
	virtual void MonitorStreamMgrTerm() = 0;
};
