...
public abstract class WwiseSoundEngineVersionBase
{
	public abstract List<string> AkLibs { get; }
	public abstract string VersionNumber { get; }
	
	public virtual void Apply(WwiseSoundEngine SE, ReadOnlyTargetRules Target, bool Latest = false)
	{
#if UE_5_3_OR_LATER
		...
		if (WwiseUEPlatformInstance.WwiseConfigurationDir.Contains("Release") || !IsWwiseTargetSupported)
		{
			SE.PublicDefinitions.Add("AK_OPTIMIZED");
		}
		
		if (WwiseUEPlatformInstance.WwiseConfigurationDir.Contains("Debug") && IsWwiseTargetSupported)
		{
	...
	public void ApplyWaapi(WwiseAuthoring SE, ReadOnlyTargetRules Target, bool Latest = false)
	{
#if UE_5_3_OR_LATER
		ILogger Logger = Target.Logger;
#endif
	...
	protected List<string> GetAvailablePlatforms(string ModuleDir)
	{
