...
public abstract class WwiseUEPlatform_Windows : WwiseUEPlatform
{
	public WwiseUEPlatform_Windows(ReadOnlyTargetRules in_TargetRules, string in_ThirdPartyFolder) : base(in_TargetRules, in_ThirdPartyFolder) {}
...
public class WwiseUEPlatform_Win32 : WwiseUEPlatform_Windows
{
	public WwiseUEPlatform_Win32(ReadOnlyTargetRules in_TargetRules, string in_ThirdPartyFolder) : base(in_TargetRules, in_ThirdPartyFolder) {}
	public override string PlatformPrefix { get { return "Win32"; } }
}

public class WwiseUEPlatform_Win64 : WwiseUEPlatform_Windows
{
	public WwiseUEPlatform_Win64(ReadOnlyTargetRules in_TargetRules, string in_ThirdPartyFolder) : base(in_TargetRules, in_ThirdPartyFolder) {}
