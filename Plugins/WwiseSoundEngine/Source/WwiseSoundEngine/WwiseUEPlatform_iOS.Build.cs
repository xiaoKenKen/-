...
public class WwiseUEPlatform_IOS : WwiseUEPlatform
{
	...
	public override string AkPlatformLibDir { get { 
			...
			if (Version.Length == 2)
			{
				...
				return "iOS_Xcode" + Major + "00";
			}
#if UE_5_7_OR_LATER
		return "iOS_Xcode1600"; 
#else
		return "iOS_Xcode1500"; 
#endif
		} 
	}
	...
	{
		string IOSPlatformFolderDefine = string.Format("WWISE_IOS_PLATFORM_FOLDER=\"{0}\"", AkPlatformLibDir);
		return new List<string>
		{
			IOSPlatformFolderDefine
		};
	}
	...
	{
		get { return Path.Combine(WwiseConfigurationDir + "-iphoneos"); }
	}
