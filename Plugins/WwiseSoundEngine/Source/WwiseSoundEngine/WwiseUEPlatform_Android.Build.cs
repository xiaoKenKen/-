...
public class WwiseUEPlatform_Android : WwiseUEPlatform
{
	private List<string> AndroidSDKFolders;
	public WwiseUEPlatform_Android(ReadOnlyTargetRules in_TargetRules, string in_ThirdPartyFolder) : base(in_TargetRules, in_ThirdPartyFolder) 
	{
