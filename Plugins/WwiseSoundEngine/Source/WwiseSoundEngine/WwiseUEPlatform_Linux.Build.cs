...
public class WwiseUEPlatform_Linux : WwiseUEPlatform
{
	public WwiseUEPlatform_Linux(ReadOnlyTargetRules in_TargetRules, string in_ThirdPartyFolder) : base(in_TargetRules, in_ThirdPartyFolder) {}
