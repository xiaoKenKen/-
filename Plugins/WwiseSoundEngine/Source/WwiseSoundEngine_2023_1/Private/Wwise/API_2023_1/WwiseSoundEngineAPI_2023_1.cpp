...
#ifdef AK_SUPPORT_WCHAR
AKRESULT FWwiseSoundEngineAPI_2023_1::PrepareBus(
...
AkUniqueID FWwiseSoundEngineAPI_2023_1::FDynamicDialogue::ResolveDialogueEvent(
		AkUniqueID			in_eventID,
...
AKRESULT FWwiseSoundEngineAPI_2023_1::FDynamicDialogue::GetDialogueEventCustomPropertyValue(
	AkUniqueID in_eventID,
	AkUInt32 in_uPropID,
	AkInt32& out_iValue
	)
...
void FWwiseSoundEngineAPI_2023_1::FDynamicSequence::FPlaylist::Enqueue(
		AkUniqueID in_audioNodeID,
		AkTimeMs in_msDelay,
		void * in_pCustomInfo,
		AkUInt32 in_cExternals,
...
void FWwiseSoundEngineAPI_2023_1::FDynamicSequence::FPlaylist::RemoveAll(int Reserve)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
	Playlist.RemoveAll();
...
AK::SoundEngine::DynamicSequence::PlaylistItem* FWwiseSoundEngineAPI_2023_1::FDynamicSequence::FPlaylist::Insert(unsigned int in_uIndex)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
	return Playlist.Insert(in_uIndex);
}

void FWwiseSoundEngineAPI_2023_1::FDynamicSequence::FPlaylist::Erase(unsigned int in_uIndex)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
	Playlist.Erase(in_uIndex);
}

AK::SoundEngine::DynamicSequence::PlaylistItem& FWwiseSoundEngineAPI_2023_1::FDynamicSequence::FPlaylist::operator[](unsigned int uiIndex) const
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
	return Playlist[uiIndex];
}

bool FWwiseSoundEngineAPI_2023_1::FDynamicSequence::FPlaylist::IsEmpty() const
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
	return Playlist.IsEmpty();
}

uint32 FWwiseSoundEngineAPI_2023_1::FDynamicSequence::FPlaylist::Length() const
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
	return Playlist.Length();
}

AkPlayingID FWwiseSoundEngineAPI_2023_1::FDynamicSequence::Open(
	AkGameObjectID		in_gameObjectID,
	AkUInt32			in_uFlags,
	AkCallbackFunc		in_pfnCallback,
	void* 				in_pCookie,
...
AKRESULT FWwiseSoundEngineAPI_2023_1::FDynamicSequence::Close(
	AkPlayingID in_playingID
	)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
AKRESULT FWwiseSoundEngineAPI_2023_1::FDynamicSequence::Play( 
	AkPlayingID in_playingID,
	AkTimeMs in_uTransitionDuration,
	AkCurveInterpolation in_eFadeCurve
	)
...
AKRESULT FWwiseSoundEngineAPI_2023_1::FDynamicSequence::Pause( 
	AkPlayingID in_playingID,
	AkTimeMs in_uTransitionDuration,
	AkCurveInterpolation in_eFadeCurve
	)
...
AKRESULT FWwiseSoundEngineAPI_2023_1::FDynamicSequence::Resume(
	AkPlayingID in_playingID,
	AkTimeMs in_uTransitionDuration,
	AkCurveInterpolation in_eFadeCurve
	)
...
AKRESULT FWwiseSoundEngineAPI_2023_1::FDynamicSequence::Stop(
	AkPlayingID in_playingID,
	AkTimeMs in_uTransitionDuration,
	AkCurveInterpolation in_eFadeCurve
	)
...
AKRESULT FWwiseSoundEngineAPI_2023_1::FDynamicSequence::Break(
	AkPlayingID in_playingID
	)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
AKRESULT FWwiseSoundEngineAPI_2023_1::FDynamicSequence::Seek(
	AkPlayingID in_playingID,
	AkTimeMs in_iPosition,
	bool in_bSeekToNearestMarker
	)
...
AKRESULT FWwiseSoundEngineAPI_2023_1::FDynamicSequence::GetPauseTimes(
	AkPlayingID in_playingID,
	AkUInt32 &out_uTime,
...
AKRESULT FWwiseSoundEngineAPI_2023_1::FDynamicSequence::GetPlayingItem(
	AkPlayingID in_playingID,
...
FWwiseSoundEngineAPI_2023_1::FDynamicSequence::IPlaylist* FWwiseSoundEngineAPI_2023_1::FDynamicSequence::LockPlaylist(
	AkPlayingID in_playingID
	)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
AKRESULT FWwiseSoundEngineAPI_2023_1::FDynamicSequence::UnlockPlaylist(
