...
class FWwisePlatformAPI_2023_1_IOS : public IWwisePlatformAPI
{
public:
	UE_NONCOPYABLE(FWwisePlatformAPI_2023_1_IOS);
	FWwisePlatformAPI_2023_1_IOS() = default;
	virtual ~FWwisePlatformAPI_2023_1_IOS() override {}
...
using FWwisePlatformAPI = FWwisePlatformAPI_2023_1_IOS;
