...
class WWISESOUNDENGINE_API FWwiseSpatialAudioAPI_2023_1 : public IWwiseSpatialAudioAPI
{
public:
	UE_NONCOPYABLE(FWwiseSpatialAudioAPI_2023_1);
	FWwiseSpatialAudioAPI_2023_1();
