...
class WWISESOUNDENGINE_API FWwiseSoundEngineAPI_2023_1 : public IWwiseSoundEngineAPI
{
public:
	UE_NONCOPYABLE(FWwiseSoundEngineAPI_2023_1);
	FWwiseSoundEngineAPI_2023_1();
