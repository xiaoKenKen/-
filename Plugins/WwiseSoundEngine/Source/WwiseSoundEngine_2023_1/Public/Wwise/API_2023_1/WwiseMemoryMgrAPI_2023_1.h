...
class WWISESOUNDENGINE_API FWwiseMemoryMgrAPI_2023_1 : public IWwiseMemoryMgrAPI
{
public:
	UE_NONCOPYABLE(FWwiseMemoryMgrAPI_2023_1);
	FWwiseMemoryMgrAPI_2023_1() = default;
