...
#include "Wwise/API_2024_1/Platforms/IOS/IOSAPI_2024_1.h"
...
void FWwisePlatformAPI_2024_1_IOS::ChangeAudioSessionProperties(
...
AkDeviceID FWwisePlatformAPI_2024_1_IOS::GetDeviceIDFromPlayerIndex(int playerIndex)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
