...
class WWISESOUNDENGINE_API FWwiseStreamMgrAPI_2024_1 : public IWwiseStreamMgrAPI
{
public:
	UE_NONCOPYABLE(FWwiseStreamMgrAPI_2024_1);
	FWwiseStreamMgrAPI_2024_1() = default;
