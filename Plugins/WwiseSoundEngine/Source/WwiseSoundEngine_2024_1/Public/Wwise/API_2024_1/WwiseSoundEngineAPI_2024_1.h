...
class WWISESOUNDENGINE_API FWwiseSoundEngineAPI_2024_1 : public IWwiseSoundEngineAPI
{
public:
	UE_NONCOPYABLE(FWwiseSoundEngineAPI_2024_1);
	FWwiseSoundEngineAPI_2024_1();
