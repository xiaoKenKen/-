...
class WWISESOUNDENGINE_API FWwiseMemoryMgrAPI_2024_1 : public IWwiseMemoryMgrAPI
{
public:
	UE_NONCOPYABLE(FWwiseMemoryMgrAPI_2024_1);
	FWwiseMemoryMgrAPI_2024_1() = default;
