...
class WWISESOUNDENGINE_API FWwiseMusicEngineAPI_2024_1 : public IWwiseMusicEngineAPI
{
public:
	UE_NONCOPYABLE(FWwiseMusicEngineAPI_2024_1);
	FWwiseMusicEngineAPI_2024_1() = default;
