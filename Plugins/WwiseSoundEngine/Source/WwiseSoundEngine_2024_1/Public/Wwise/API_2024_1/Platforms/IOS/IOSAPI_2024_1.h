...
class FWwisePlatformAPI_2024_1_IOS : public IWwisePlatformAPI
{
public:
	UE_NONCOPYABLE(FWwisePlatformAPI_2024_1_IOS);
	FWwisePlatformAPI_2024_1_IOS() = default;
	virtual ~FWwisePlatformAPI_2024_1_IOS() override {}
...
using FWwisePlatformAPI = FWwisePlatformAPI_2024_1_IOS;
