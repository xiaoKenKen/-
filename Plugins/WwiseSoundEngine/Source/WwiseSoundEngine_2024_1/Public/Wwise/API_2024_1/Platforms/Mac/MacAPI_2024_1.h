...
class FWwisePlatformAPI_2024_1_Mac : public IWwisePlatformAPI
{
public:
	UE_NONCOPYABLE(FWwisePlatformAPI_2024_1_Mac);
	FWwisePlatformAPI_2024_1_Mac() = default;
	virtual ~FWwisePlatformAPI_2024_1_Mac() override {}
...
using FWwisePlatformAPI = FWwisePlatformAPI_2024_1_Mac;
