...
const AkUInt32 kRayPoolBlockAllocItemCount = 35;	// Number of items per block to allocate for in AkStochasticRay
...
namespace AK
{
	namespace SpatialAudio
	{
		...
		typedef AkDbString<ArrayPoolSpatialAudio, char> DbString;		///< Instanced string type.
		typedef AkDbWeakString<ArrayPoolSpatialAudio, char> DbWeakString; ///< Weak reference to DbString. Multi-thread reading is safe.
