	...
	namespace Wwise
	{
		...
		public:
			...
			virtual void AddLogMessage ( 
				Severity in_severity,		///< The severity of the text line to log.
			...
			/// this function, AK:Wwise::ISourceControlProgress::EndOperation() must be called to
			/// close the dialog.
