...
void FUAssetDataSource::GetAssetsInfo(FGuid ItemId, uint32 ShortId, FString Name, uint32 GroupId, EWwiseItemType& ItemType, FName& AssetName, TArray<FAssetData>& Assets)
{
