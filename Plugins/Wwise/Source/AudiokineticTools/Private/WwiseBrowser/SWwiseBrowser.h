...
public:
	...
	bool IsItemExpanded(FWwiseTreeItemPtr TreeItem) const;
...
private:
	...
	bool HandleExpandSelectedCommandCanExecute();
	bool HandleCollapseSelectedCommandCanExecute();

	bool CanExpandOrCollapseItemRecursive(FWwiseTreeItemPtr TreeItem, bool bShouldExpand) const;
