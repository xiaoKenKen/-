...
public:
	...
	/** Counter for tracking active async database operations */
	static std::atomic<int32> ActiveDatabaseOperations;
	...
	void OnApplicationDeactivated(const bool IsActive);
	
private:
	void InitializeAkAudioDevice();
};
