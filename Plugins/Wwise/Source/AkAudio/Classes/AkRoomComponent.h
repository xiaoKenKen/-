...
public:
	...
	*/
	...
	virtual void AddSpatialAudioRoom();
	...
	*/
	...
	virtual void RemoveSpatialAudioRoom();

	virtual bool HasEffectOnLocation(const FVector& Location) const;
...
protected:
	...
	virtual void GetRoomParams(AkRoomParams& outParams);
private:
