...
using UAkInitializationSettings = UAkLinuxArm64InitializationSettings;

struct AKAUDIO_API FAkLinuxArm64Platform : FAkPlatformBase
{
	static const UAkInitializationSettings* GetInitializationSettings()
	{
		return GetDefault<UAkLinuxArm64InitializationSettings>();
	}
...
using FAkPlatform = FAkLinuxArm64Platform;
