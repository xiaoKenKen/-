...
UENUM(BlueprintType, meta=(ScriptName="EPanningRule"))
...
UENUM(BlueprintType, meta=(ScriptName="EAkAcousticPortalState"))
...
UENUM(BlueprintType, meta=(ScriptName="EAkChannelConfiguration"))
...
UENUM(BlueprintType, meta=(ScriptName="EAkMultiPositionType"))
...
UENUM(BlueprintType, meta=(ScriptName="EAkActionOnEventType"))
...
class AKAUDIO_API AkCallbackTypeHelpers
{
public:
...
UENUM(BlueprintType, meta=(ScriptName="EAkCodecId"))
...
struct AKAUDIO_API FAkSDKExternalSourceArray :  public TSharedFromThis<FAkSDKExternalSourceArray, ESPMode::ThreadSafe>
{
