...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, BlueprintCosmetic, Category="Audiokinetic", meta=(WorldContext="WorldContextObject"))
	...
	*/
	...
	/**
	* Sets the obstruction and occlusion value of sounds going through this portal with a call to AK::SpatialAudio::SetPortalObstructionAndOcclusion.
