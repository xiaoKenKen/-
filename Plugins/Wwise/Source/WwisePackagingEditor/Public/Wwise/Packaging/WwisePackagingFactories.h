...
UCLASS(HideCategories=(Object))
class WWISEPACKAGINGEDITOR_API UWwiseAssetLibraryGroupFactory : public UFactory
{
	GENERATED_BODY()

public:
	UWwiseAssetLibraryGroupFactory(const FObjectInitializer& ObjectInitializer);
