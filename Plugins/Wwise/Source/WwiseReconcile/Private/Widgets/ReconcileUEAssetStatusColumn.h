...
class FReconcileUEAssetStatusColumn : public IWwiseReconcileColumn
{
	FText GetDisplayedName(FWwiseReconcileItem TreeItem);
public:
	virtual ~FReconcileUEAssetStatusColumn() {}
