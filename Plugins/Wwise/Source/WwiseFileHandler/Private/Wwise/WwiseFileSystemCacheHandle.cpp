...
void FWwiseFileSystemCacheHandle::OnCloseAndDelete()
{
	...
	UE_LOG(LogWwiseFileHandler, VeryVerbose, TEXT("FWwiseFileSystemCacheHandle::OnCloseAndDelete (%p) [%" PRIi32 "]: Deleting object."), this, FPlatformTLS::GetCurrentThreadId());
	delete this;
}
